                ...
                <form className="space-y-5 text-sm md:text-base lg:text-2xl" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="rounded-2xl px-4 py-6 border">
                            ...
                            <button
                                type="button"
                                className={`w-full shadow border rounded-2xl px-4 py-6 ${paymentMethod === 'upi' ? 'bg-green-100 border-green-500' : 'bg-white'}`}
                        ...
                        <div className="rounded-2xl px-4 py-6 border">
                            ...
                            <button
                                type="button"
                                className={`w-full shadow border rounded-2xl px-4 py-6 ${paymentMethod === 'card' ? 'bg-green-100 border-green-500' : 'bg-white'}`}
